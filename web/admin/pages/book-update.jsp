...
<body>
	...
	<form action="admin!bookUpdate.action" method="post" enctype="multipart/form-data">
		...
		图片：<img src="../${book.cover}" width="150px" height="150px">
		<br>
		修改: <input type="file" name="photo" size="12"/><br>
		名称：<input type="text" name="book.name" value="${book.name}"/><br>
		价格：<input type="text" name="book.price" value="${book.price}"/><br>
		介绍：<input type="text" name="book.intro" value="${book.intro}"/><br>
		品牌：<input type="text" name="book.auther" value="${book.auther}"/><br>
		生产商：<input type="text" name="book.press" value="${book.press}"/><br>
		生产日：<input type="text" id="datepicker" name="book.pubdate" value="${book.pubdate}"/><br>
