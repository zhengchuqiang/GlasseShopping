...
<body>
	...
	<form action="admin!bookAdd.action" method="post" enctype="multipart/form-data">
		 ...
		 图 片：<input type="file" name="photo" size="12"/><br>
		 名 称：<input type="text" name="book.name"/><br>
		 价 格：<input type="text" name="book.price"/><br>
		 介 绍：<input type="text" name="book.intro"/><br>
		 品 牌：<input type="text" name="book.auther"/><br>
		生厂商：<input type="text" name="book.press"/><br>
		生产日：<input type="text" id="datepicker" name="book.pubdate"/><br>
		眼镜分类:  <select name="book.category.id">
