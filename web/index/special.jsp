...
<div class="center_content">
	...
	<div class="left_content">
		...
		<div class="title"><span class="title_icon"><img src="images/bullet1.gif"/></span>精选推荐</div>
     	...
     	<s:iterator value="specialList">
	     	...
	     	<div class="feat_prod_box">
				...
				<div class="prod_det_box"><span class="special_icon"><img src="images/special_icon.gif"/></span>
					...
					<div class="box_center">
						...
						<a href="detail.action?bookid=${id}" class="more">- 眼镜详情 -</a>
						<div class="clear"></div>
					</div>
