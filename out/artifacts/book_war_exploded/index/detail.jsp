            ...
            <div class="feat_prod_box_details">
                ...
                <div class="prod_det_box">
                    ...
                    <div class="box_center">
                        ...
                        <p class="details"><s:property
                                value="book.intro.substring(0,(intro.length()>70?70:intro.length()))+'...'"/></p>
            ...
            <div id="demo" class="demolayout">
                ...
                <div class="tabs-container">
                    <div style="display: block;" class="tab" id="tab1">
                        ...
                        <ul class="list">
                            <li><a href="">品牌: ${book.auther}</a></li>
                            <li><a href="">生产商: ${book.press}</a></li>
                            <li><a href="">生产日: ${book.pubdate}</a></li>
                            <li><a href="">眼镜分类: ${book.category.name}</a></li>
                        </ul>
                    </div>
